...
})({"byJNR":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b821c43b9cf9c461";
"use strict";
...
boton?.addEventListener('submit', (event)=>{
    ...
    ;
    const valor = boton.querySelector('input[type="search"]'); //VARIABLE QUE SELECCIONA EL INPUT y LO TIPA CON HTMLInputElement PARA USAR EL .value
...
function mostrarPokemon(data) {
    ...
    const tiposNombres = data.types.map((element)=>element.type.name);
...
},{}]},["byJNR","ahnQa"], "ahnQa", "parcelRequire7b22", {})

//# sourceMappingURL=app-pokemon.9cf9c461.js.map
